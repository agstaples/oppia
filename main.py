...
URLS = MAPREDUCE_HANDLERS + [
    ...
    get_redirect_route(r'%s' % feconf.LIBRARY_INDEX_URL, library.LibraryPageHandler),
    ...
    get_redirect_route(r'%s' % feconf.LIBRARY_SEARCH_URL, library.LibraryPageHandler),
    get_redirect_route(
    ...
    get_redirect_route(r'/emaildashboard', email_dashboard.EmailDashboardPageHandler),
    get_redirect_route(
